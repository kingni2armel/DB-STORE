...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 25 oct. 2021 à 14:03
...
(111, 4, 20, 'product', 'bureau', 'Jolie bureau a vendre.\r\nbureau contenant \r\n- une chaise\r\n- une table grande\r\n- une lampe Led équipée de laser\r\n- un classeur.\r\nLa lampe est de marque CisseLamp - une lampe durable et très adaptée au bureau.', 1000, '2021-10-21 13:45:25'),
(112, 4, 20, 'product', 'yutyityutyui', 'tyrtyrtutyuiuyuiy', 2552, '2021-10-21 13:47:10'),
(114, 4, 20, 'product', 'bureau', 'Jolie espace de bureau composé de: \r\n- Une chaise équipée de mousse;\r\n-Une table grande pour les études et le travail;\r\n-Une ampoule de travail.\r\n\r\nEn effet, si vous désirez avoir un très bel endroit pour vos devoir, ou si vous travaillez solo ou en freelance, optez pour ce magnifique bureau composé de couleur plutôt attirantes.', 30000, '2021-10-24 15:48:51');
...
(1, 'Téléphones et Tablettes', 'Phone and tablets', 'fa-mobile'),
...
(13, 'Electroménager', 'Domestic Appliance', 'fa-fa  menager'),
(14, 'Meubles', 'loose', 'fa-fa saloon');
...
(130, 114, '81417c146c3b018eb69706c4dcecac8a.jpg', '.jpg');
...
(27, 44, 48, 'sdfdsfsdfsdfsdfsdfsdfsdf', 1, '2021-08-06 05:09:50'),
(28, 44, 48, 'kdsod', 0, '2021-10-24 16:04:31'),
(29, 53, 44, 'interessé par l\'article', 0, '2021-10-24 17:30:23'),
(30, 53, 48, 'h', 1, '2021-10-24 17:33:59');
...
INSERT INTO `utilisateur` (`id_user`, `nom_user`, `prenom_user`, `email_user`, `phone_user`, `password`, `privilege`) VALUES
(44, 'Kamen', 'Joachim', 'likound.kamen@gmail.com', '655447198', '$2y$10$C0EjSbzxAbJQTvhS0Qe71O02usuywkrEz2y3F5wl0.opNgB9ioJmK', 'seller'),
(45, 'Mbong ', 'Pierre ', 'mbp@gmail.com', '655443434', 'o', 'seller'),
(46, 'Kingni', 'Borid                   ', 'armel@gmail.com               ', '677829009                   ', '$2y$10$C0EjSbzxAbJQTvhS0Qe71O02usuywkrEz2y3F5wl0.opNgB9ioJmK', 'customer'),
(47, 'kamdem', 'joseph', 'kamdemjoseph@gmail.com', '55555', 'o', 'seller'),
(48, 'Afric', 'Village', 'africvillage@gmail.com', '55555555', '$2y$10$C0EjSbzxAbJQTvhS0Qe71O02usuywkrEz2y3F5wl0.opNgB9ioJmK', 'administrator'),
(49, 'lkjkjl', 'lkjlkj', 'lkjlkj@gmail.com', '88888888', 'eeeeeeee', 'customer'),
(50, 'kamen', 'romuald', 'kamenr@gmail.com', '44444444', 'oooooooo', 'seller'),
(51, 'etyert', 'rtertr', 'tese@gmail.com', '88888888', '$2y$10$fX3RGptYW/45IbVHXf3ZTO3N3JYkCWwEOqxGslideumOfTa.Ceu.O', 'customer'),
(52, 'pain', 'pate', 'painpate@gmail.com', '55555555', '$2y$10$6r0rDa2E0YAA9t/OZ.2d2OTSgpQFOHcFkf1qKH8b.9s4I4CIIjszO', 'seller'),
(53, 'Cisse', 'Oumar', 'oumarcisse202@gmail.com', '657216586', '$2y$10$LgyNt.hvIIf4y0EqWDMg3utP3PrY.PAvBG5DRc/WhojAVvobawJ.6', 'customer');
...
--
ALTER TABLE `article`
  MODIFY `id_article` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
--
ALTER TABLE `image_of_article`
  MODIFY `id_image` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
