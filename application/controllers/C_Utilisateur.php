...
{ 
	...
	{  
		...
		switch ($countArg) {
			case 5:
				# code...
				$this->Utilisateur5($args[0], $args[1], $args[2], $args[3], $args[4]);
				break;
			case 6:
				# code...
				$this->Utilisateur6($args[0], $args[1], $args[2], $args[3], $args[4], $args[5]);
				break;
			case 7:
				# code...
				$this->Utilisateur7($args[0], $args[1], $args[2], $args[3], $args[4], $args[5], $args[6]);
				break;
			default:
				//Utilisateur();
				break;
	...
	* @Utilisateur7 : constructeur de la classe
	 * @param : nom, prenom, email, phone, motDePasse, adresse
	 * @return : true
	 */
	private function Utilisateur5($nom, $prenom, $email, $phone, $pwd)
	{
		$this->_nomUser = $nom;
	 ...
	 * @param : nom, prenom, email, phone, motDePasse, idUser, privilege
	 * @return : true
	 */
	//___Constructeur a 8 parametres
	private function Utilisateur6($nom, $prenom, $email, $phone, $id_user, $privilege)
	{
	 ...
	 */
	//___Constructeur a 8 parametres
	private function Utilisateur7($nom, $prenom, $email, $phone,$pwd, $id_user, $privilege)
	{
		$this->_idUser = $id_user;
		$this->_nomUser = $nom;
		$this->_prenomUser = $prenom;
