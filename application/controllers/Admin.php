	 ...
	 **/
		public function login(){
			...
			if ($this->form_validation->run() == true ){
				...
				if (is_array($data)) {
					...
					$_SESSION['S_id_shop'] = "20";
					$_SESSION['id_seller'] = "20";
		...
		public function publications(){
			...
			/*if (empty($_SESSION['id_shop'])) {
				...
				$req .= "WHERE a.id_article = i.id_article AND a.id_shop = ".$_SESSION['S_id_shop'].' ';
				...
				else
				{
					...
					$this->load->view('admin/publications',$data); //___vue de la page des publications
				}
			//}
