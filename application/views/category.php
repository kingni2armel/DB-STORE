                    ...
                    <tr>
                        ...
                        <td> 
                            <p>
                                ...
                                <a style="background-color:#FBD219;border:1px solid #fbd219" href="<?= base_url('more/').$row->id_article ?>" class="btn btn-primary"><?= $this->lang->line('category_moreInfo') ?><i class="fa fa-plus-circle"></i></a> </p>
                        </td>
                    </tr>
                </tbody>
<?php
