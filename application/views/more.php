...
?>
                    <p><a href="#" class="btn btn-success" style="background-color:#FDB219;border:1px solid #FDB219"><i class="fa fa-phone" aria-hidden="true"></i> <?= $results[0]->phone_user ?></a></p>
                 ...
                 <div class="" style="margin-top: 50px;margin-left:15px"> 
          <div class="card w-80">
            <div class="btn-group"> 
...
if (validation_errors()) {
  ...
  ?>
              <div class="conteiner_message" id="conteiner-message">
                ...
                <button style="background-color:#FDB219 !important;border:1px solid #FDB219" type="submit" class="btn btn-success"><?= $this->lang->line('more_envoyerButton') ?></button> 
              </div>
            </div>
            </form>
              ...
              <div class="card-body">
                      ...
                      <div class="vv" id="">
                        ...
                        <div class="ll">
                            ...
                            <button style="background-color:#FDB219 !important;border:1px solid #FDB219"  type="submit" class="btn btn-success">Envoyer</button>
                        </div>
                      </div>
                        </form>
              </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Vous devez vous connecter pour avoir plus d'informations sur les coordonnées de boutique !!!
      </div>
