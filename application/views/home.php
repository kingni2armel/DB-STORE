...
<head>
  ...
  <meta name="description"  content=" tout de la brocante ici au pays">
  <title>meilleure brocante du cameroun</title>
</head>
...
<body>   
  ...
  <div class="info_parent homeshow" style="margin-top: -1550px !important;">
    <div class="info_parent_items" style="margin-left: 2.3vw;">
          <p class="name_category " style="font-weight:;color:#fdb219">
            <?php
              if ($_SESSION['site_lang'] == "french") {
                echo "Téléphones et tablettes";
              }else{
            ...
            if (sizeof($cat1)>5) {
                foreach ($cat1 as $row) {
                  ...
                  <div id="conteiner_see"class="card me-2">
                    <h5 style="background-color:#FDB219 !important;color:white;font-family:poppins !important" class="card-header"><?=$row->name_article ?></h5>
                    <div class="card-body">
                      ...
                      <p style="text-align: center;color:#3568e8" class="card-text"><?= $this->lang->line('prix') ?> : <?php if($row->price=='0'){echo '<span class="badge bg-success">Gratuit</span>';}else{echo $row->price.' $';} ?></p>
                           
                             
                      <a  id="moreinfo" style="margin-left:25px;margin-top:-6px;background-color:#FDB219;border:1px solid #FDB219" href="<?= base_url('more/').$row->id_article ?>" class="btn btn-primary"><?= $this->lang->line('info') ?></a> 
                ...
                foreach ($cat2 as $row) {
                  ...
                  <div id="conteiner_see" class="card me-2">
                    ...
                    <div class="card-body">
                      ...
                      <p style="text-align: center;color:#3568e8" class="card-text"><strong><?= $this->lang->line('prix') ?> : </strong><?php if($row->price=='0'){echo '<span class="badge bg-success">Gratuit</span>';}else{echo $row->price.' $';} ?></p>
                      <a  id="moreinfo" style="margin-left:25px;margin-top:-6px;background-color:#FDB219 !important;border:1px solid #FDB129" href="<?= base_url('more/').$row->id_article ?>" class="btn btn-primary"><?= $this->lang->line('info') ?></a> 
                ...
                foreach ($cat3 as $row) {
                  ...
                  <div id="conteiner_see" class="card me-2">
                    ...
                    <div class="card-body">
                      ...
                      <p style="text-align: center;color:#3568e8" class="card-text"><strong><?= $this->lang->line('prix') ?> : </strong><?php if($row->price=='0'){echo '<span class="badge bg-success">Gratuit</span>';}else{echo $row->price.' $';} ?></p>
                      <a   id="moreinfo"style="margin-left:25px;margin-top:-6px;background-color:#FDB219 !important;border:1px solid #FD8219" href="<?= base_url('more/').$row->id_article ?>" class="btn btn-primary"><?= $this->lang->line('info') ?></a> 
