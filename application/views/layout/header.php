...
//___somme des messages non lu de l'utilisateur 
  ...
  ?>
  <nav class="navbar navbar-expand-md navbar-dark bg-primary" style="background-color:#fdb219  !important">
    <div class="container-fluid">
      ...
      <a style="margin-left: 5px;" class="navbar-brand" href="<?= base_url('home'); ?>"><img  style="border-radius:15px" src="<?php echo base_url().'images/dbstorelogo.png';?>"></a>
      ...
      <form method="post" class="d-flex d-none d-lg-flex">
        ...
        <div class="input-group" style="">
          ...
          <input style="width:210px" class="form-control me-1" type="text" placeholder="<?= $this->lang->line('header_recherche') ?>" aria-label="Search" name="element">
        </div> 
        <!--input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"-->
        <button class="btn btn-outline-primary me-2" style="background-color:#3568e8;color:white;border:1px solid #3568e8" type="submit" name="srch"><?= $this->lang->line('header_boutton-rechercher') ?></button>      
      </form> 
      <?php 
    ...
    else
    {
      ...
      <form class="d-flex me-2" method="post"> 
        <div class="d-grid gap-2 col-12 mx-auto">
            <button class="btn " style="background-color:#3568e8 !important;border:1px solid #3568e8;color:white" name="signup" type="submit"><?= $this->lang->line('header_inscription') ?></button>
        </div>
      </form>
      <form class="d-flex me-2" method="post"> 
        <div class="d-grid gap-2 col-12 mx-auto">
          <button class="btn btn-outline-primary"style="background-color:#3568e8;border:1px solid #3568e8;color:white" name="connection" type="submit"><?= $this->lang->line('header_connexion') ?></button> 
        </div>
      </form> 
      <?php
    }
    ?>
    <form method="post">
      <button name="en" style="background-color:#3568e8 !important;" class=" lang btn btn-primary"><u>EN</u></button>
      <button name="fr" style="background-color:#3568e8;" class=" lang btn btn-primary"><u>FR</u></button>
    </form>
  </div>
</div>
</nav>
