...
.pantouroo{
 width:90%;
  ...
  <!-- <div class="mySlid fadee">
    <img class="ima" src="<?php echo base_url('images/dbstorelogo.png'); ?>" style="width:100%">
  </div> -->
  <div class="mySlid fadee">
    <img class="ima" src="<?php echo base_url('images/traite.png'); ?>" style="width:100%">
  </div>
  
  <div class="mySlid fadee">
    <img class="ima" src="<?php echo base_url('images/traite2.png'); ?>" style="width:100%">
  </div>
  
  <div class="mySlid fadee">
    <img class="ima" src="<?php echo base_url('images/traite3.png'); ?>" style="width:100%">
  </div>
