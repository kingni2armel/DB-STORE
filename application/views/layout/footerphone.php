				...
				<div class="data-footer-items" >
                                ...
                                <div class="data-footer-items" >
                                        <ul>
                                                        ...
                                                        <li><i class="fa fa-map-marker" style="color:#2ebed7" aria-hidden="true"></i><?= $this->lang->line('apropos') ?></li>
                                                        <li><i class="fas fa-envelope" style="color:#2ebed7"></i><?= $this->lang->line('utilisation') ?></li>
                                                        <li><i class="fas fa-phone" style="color:#2ebed7"></i><?= $this->lang->line('echanges') ?></li>
                                                        <li><i class="fas fa-phone" style="color:#2ebed7"></i><?= $this->lang->line('echanges2') ?></li>
                                        </ul>
